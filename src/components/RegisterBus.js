...
export default function RegisterBus(props) {
  ...
  const [departureTimeObj, setDepartureTimeObj] = useState({
    hour: "09",
    minute: "00",
    period: "AM",
  });
  ...
  useEffect(() => {
    ...
    if (role !== "agency") {
      props.showAlert("Only travel agencies can register buses", "warning");
      navigate("/");
      return;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      props.showAlert(
        err.response?.data?.message || "Error registering bus",
        "danger",
      );
    }
  };
    ...
    <>
      <div style={{ position: "relative", zIndex: 1 }}>
        <div className="mb-4">
          ...
          >
            Add a new bus route to BookMyTrip
            <div
              style={{
                width: "100px",
                height: "4px",
            ...
            <div className="col-md-6">
              ...
              <div className="mb-4">
                ...
                >
                  <option
                    value=""
                    style={props.darkMode ? { backgroundColor: "#1a1a1a" } : {}}
                  >
                    Select Source
                  </option>
                  {places.map((place) => (
                    ...
                    (day) => (
                      <div key={day} className="form-check">
                        <input
                          ...
                          style={{
                            cursor: "pointer",
                            backgroundColor: bus.daysOfWeek.includes(day)
                              ? "#3b82f6"
                              : props.darkMode
                                ? "rgba(255,255,255,0.2)"
                                : "rgba(0,0,0,0.1)",
                            borderColor: bus.daysOfWeek.includes(day)
                              ? "#3b82f6"
                              : props.darkMode
